...
:QEMM
IF EXIST C:\\DRIVERS\\SHSUCDX.COM C:\\QEMM\\LOADHI /RF C:\\DRIVERS\\SHSUCDX.COM /D:IDE-CD /L:F /V /C
...
IF EXIST C:\\DRIVERS\\SHSUCDX.COM LOADHIGH C:\\DRIVERS\\SHSUCDX.COM /D:IDE-CD /L:F /V /C
IF EXIST C:\\DOS\\ASSIGN.COM LOADHIGH ASSIGN D:=F:
